process blast {
    ...
    """
      ...
      printf \$HEADER_BLAST > ${confidence_set_name}.blast
      printf \$HEADER_BLAST > ${confidence_set_name}.filtered.blast
      printf "\$HEADER_BLAST\\t\$HEADER_IMGVR" > ${confidence_set_name}.filtered.meta.blast
      ...
      for HIT_LINE in \$(grep -v qseqid ${confidence_set_name}.filtered.blast); do
        ...
        printf \$HIT_LINE_CLEAN >> ${confidence_set_name}.filtered.meta.blast
