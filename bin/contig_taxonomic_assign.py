...
def contig_tax(annot_df, min_prot, prop_annot, tax_thres, db_file):
...
if __name__ == "__main__":
	...
	parser.add_argument("-d", "--database", dest = "db_file", help = "The NCBI taxonomy dump", required = True)
	...
	if len(sys.argv) == 1:
		...
		output_df = contig_tax(input_df, args.min_prot, args.prot_prop, args.tax_thres, args.db_file)
